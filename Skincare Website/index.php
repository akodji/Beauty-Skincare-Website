...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="actions/routine.php"><i class="fas fa-calendar-alt me-1"></i> Routines</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="actions/products.php"><i class="fas fa-flask me-1"></i> Products</a>
                    </li>

                    <?php if (!isLoggedIn()): ?>
                        <li class="nav-item">
                            <a class="nav-link" href="actions/login.php"><i class="fas fa-sign-in-alt me-1"></i> Login</a>
                        </li>
                    <?php endif; ?>
    ...
    <section class="hero-section">
        <div class="container text-center">
            ...
            <a href="actions/login.php" class="btn btn-dark btn-lg">Get Started</a>
        </div>
    </section>
